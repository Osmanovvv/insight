...
import { getUser, removeUser, isAuthenticated, logout } from "@/lib/auth";
import { LogOut, LayoutDashboard, Moon, Sun, User, Brain, ShieldCheck } from "lucide-react";
      ...
      <header className="fixed top-0 w-full bg-background/80 backdrop-blur-lg border-b border-border z-50">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <Link to={isAuthenticated() ? (isAdmin ? "/admin" : "/blog") : "/"} className="flex items-center gap-2">
